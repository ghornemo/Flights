...
public class DomesticFlight extends JFrame
{
	...
	public DomesticFlight(LoginPage type1)
	{
		...
		String[] sItem1={"Saint John"};
		String[] sItem2 ={ "Toronto", "Monteral ", "Ottawa", "St. John's", "BC", "Pittsburgh", "Boston", "Calgary", "Halifax" };
		...
		PPanel1.add(LImg1);
		PPanel1.setBackground(Color.red);
